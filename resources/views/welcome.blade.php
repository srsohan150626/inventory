...
<body id="page-top">
  ...
  v-show="$route.path === '/' || $route.path === '/register' || $route.path==='/forget' ? false : true ">
     ...
     <a class="navbar-brand mr-1 "  href="index.html"><b class="text-center">TECH CLOUD </b><img src="{{asset('backend/logo.webp')}}" height="50px" width="50px" alt=""> </a>
    ...
    <ul class="sidebar navbar-nav" id="leftbar" style="display: none;"
      ...
      <li class="nav-item bg-info">
        <router-link class="nav-link" to="/pos">
          <i class="fas fa-fw fa-tachometer-alt text-red"></i>
          <span class="text-red"><b>POS</b></span>
        </router-link>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <router-link class="dropdown-item" to="/customer">All Customers</router-link>
        </div>
      </li>
