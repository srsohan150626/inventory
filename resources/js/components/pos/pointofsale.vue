                    ...
                    <a class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModal" id="add_new"> Add Customer</a>
                              ...
                              <tbody>
                               <tr v-for="card in cards" :key="card.id">
                                     ...
                                     <td><input type="text" readonly="" style="width: 20px;" :value="card.pro_quantity">
                                      ...
                                      <button  @click.prevent="decrement(card.id)" class="btn btn-sm btn-info" v-if="card.pro_quantity >= 2">-</button>
                      ...
                      <div class="card-footer">
                          <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                  Total:
                                  <strong>{{subtotal*vats.vat/100 + subtotal}}  Taka</strong>
                            </li>
                          </ul>
                          <br>
                          ...
                          <label>Pay</label>
                          <input type="" class="form-control" required v-model="pay">

                           <label>due</label>
                          <input type="" class="form-control" required v-model="due">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="product in filtersearch" :key="product.id">
                                    ...
                                    <div class="card" style="width: 9rem; height: 180px;">
                                        <img :src="product.image" height="100px" width="100px" class="card-img-top">
                                        <div class="card-body">
                                            <small class="card-title">{{ product.product_name }}</small> <br>
                                        <span v-if="product.product_quantity >= 1"><span class="badge badge-success">Available({{product.product_quantity}})</span></span>
